class PortfolioAccountStatus {
  String? cmd;
  String? oID;
  int? rc;
  String? rs;
  PortfolioAccount? data;

  PortfolioAccountStatus({this.cmd, this.oID, this.rc, this.rs, this.data});

  PortfolioAccountStatus.fromJson(Map<String, dynamic> json) {
    cmd = json['cmd'];
    oID = json['oID'];
    rc = json['rc'];
    rs = json['rs'];
    data =
        json['data'] != null ? PortfolioAccount.fromJson(json['data']) : null;
  }
...
class PortfolioAccount {
  ...
  PortfolioAccount.fromJson(Map<String, dynamic> json) {
    assets = json['assets'];
    imKH = json['imKH'];
    h = json['h'];
    equity = json['equity'];
