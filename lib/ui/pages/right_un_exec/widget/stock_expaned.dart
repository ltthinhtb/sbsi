...
class StockExpanded extends StatefulWidget {
  const StockExpanded({Key? key}) : super(key: key);

  @override
  State<StockExpanded> createState() => _StockExpandedState();
}

class _StockExpandedState extends State<StockExpanded> {
